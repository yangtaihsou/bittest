    ...
    (function (n) {
        ...
        function gi(n) {
            var t = u.defaults.oLanguage,
                i = n.sZeroRecords;
            !n.sEmptyTable && i && t.sEmptyTable === "No data available in table" && w(n, n, "sZeroRecords", "sEmptyTable");
            !n.sLoadingRecords && i && t.sLoadingRecords === "Loading..." && w(n, n, "sZeroRecords", "sLoadingRecords")
        }
        function fu(n) {
            a(n, "ordering", "bSort");
        ...
        function nr(n, f) {
            var o = u.defaults.column,
                ...
                s;
            n.aoColumns.push(h);
            n.aoPreSearchCols[e] === i || n.aoPreSearchCols[e] === null ? n.aoPreSearchCols[e] = r.extend(!0, {}, u.models.oSearch) : (s = n.aoPreSearchCols[e], s.bRegex === i && (s.bRegex = !0), s.bSmart === i && (s.bSmart = !0), s.bCaseInsensitive === i && (s.bCaseInsensitive = !0));
            ti(n, e, null)
        }
        function ti(n, t, f) {
            var e = n.aoColumns[t],
        ...
        function tr(n) {
            for (var h = n.aoColumns, p = n.aoData, c = u.ext.type.detect, o, a, r, y, t, e, s, f = 0, l = h.length; f < l; f++) if (t = h[f], s = [], !t.sType && t._sManualType) t.sType = t._sManualType;
            else if (!t.sType) {
        ...
        function nt(n, t, i, f) {
            var o = n.aoData.length,
                ...
                s, e, c;
            for (h._aData = t, n.aoData.push(h), s = n.aoColumns, e = 0, c = s.length; e < c; e++) i && ir(n, o, e, v(n, o, e)), s[e].sType = null;
            return n.aiDisplayMaster.push(o), n.oFeatures.bDeferRender || er(n, o, i, f), o
        }
        function ri(n, t) {
            var i;
            return t instanceof r || (t = r(t)), t.map(function (t, r) {
                return i = oi(n, r), nt(n, i.data, r, i.cells)
            })
        }
        function hu(n, t) {
        ...
        function v(n, t, r, u) {
            var e = n.aoColumns[r],
                o = n.aoData[t]._aData,
                f = e.fnGetData(o, u);
            if (f === i) return n.iDrawError != n.iDraw && e.sDefaultContent === null && (ot(n, 0, "Requested unknown parameter " + (typeof e.mData == "function" ? "{function}" : "'" + e.mData + "'") + " for row " + t, 4), n.iDrawError = n.iDraw), e.sDefaultContent;
                ...
                var t = function (n, r, u) {
                    for (var o, y, f = rr(u), s, h = f[f.length - 1], l, a, c, v, e = 0, p = f.length - 1; e < p; e++) {
                        if (l = f[e].match(yt), a = f[e].match(ft), l) {
                            for (f[e] = f[e].replace(yt, ""), n[f[e]] = [], s = f.slice(), s.splice(0, e + 1), v = s.join("."), o = 0, y = r.length; o < y; o++) c = {}, t(c, r[o], v), n[f[e]].push(c);
                            return
                        }
        ...
        function oi(n, t) {
            ...
            }; i;) o = i.nodeName.toUpperCase(), (o == "TD" || o == "TH") && (u = a[l], s = r.trim(i.innerHTML), u && u._bAttrSrc ? (f = {
                display: s
            }, h(u.mData.sort, f, i), h(u.mData.type, f, i), h(u.mData.filter, f, i), e.push(f)) : e.push(s), c.push(i), l++), i = i.nextSibling;
            return {
                data: e,
                cells: c
            }
        ...
        function lu(n) {
            var i, e, u, l, t, f = n.nTHead,
                ...
                h = n.aoColumns,
                c;
            for (o && (l = r("<tr/>").appendTo(f)), i = 0, e = h.length; i < e; i++) t = h[i], u = r(t.nTh).addClass(t.sClass), o && u.appendTo(l), n.oFeatures.bSort && (u.addClass(t.sSortingClass), t.bSortable !== !1 && (u.attr("tabindex", n.iTabIndex).attr("aria-controls", n.sTableId), ar(n, t.nTh, i))), t.sTitle != u.html() && u.html(t.sTitle), pr(n, "header")(n, u, t, s);
            if (o && wt(n.aoHeader, f), r(f).find(">tr").attr("role", "row"), r(f).find(">tr>th, >tr>td").addClass(s.sHeaderTH), r(a).find(">tr>th, >tr>td").addClass(s.sFooterTH), a !== null) for (c = n.aoFooter[0], i = 0, e = c.length; i < e; i++) t = h[i], t.nTf = c[i].cell, t.sClass && r(t.nTf).addClass(t.sClass)
        }
        function tt(n, t, u) {
            var f, a, e, y, v, p, c, o = [],
                l = [],
        ...
        function it(n) {
            ...
            var p = [],
                ...
                o = b(n) == "ssp",
                h = n.aiDisplay;
            if (n.bDrawing = !0, u !== i && u !== -1 && (n._iDisplayStart = o ? u : u >= n.fnRecordsDisplay() ? 0 : u, n.iInitDisplayStart = -1), c = n._iDisplayStart, l = n.fnDisplayEnd(), n.bDeferLoading) n.bDeferLoading = !1, n.iDraw++, k(n, !1);
            else if (o) {
                if (!n.bDestroying && !vu(n)) return
            } else n.iDraw++;
            if (h.length !== 0) for (it = o ? 0 : c, rt = o ? n.aoData.length : l, f = it; f < rt; f++) nt = h[f], t = n.aoData[nt], t.nTr === null && er(n, nt), a = t.nTr, g !== 0 && (v = d[w % g], t._sRowStripe != v && (r(a).removeClass(t._sRowStripe).addClass(v), t._sRowStripe = v)), s(n, "aoRowCallback", null, [a, t._aData, w, f]), p.push(a), w++;
            else y = e.sZeroRecords, n.iDraw == 1 && b(n) == "ajax" ? y = e.sLoadingRecords : e.sEmptyTable && n.fnRecordsTotal() === 0 && (y = e.sEmptyTable), p[0] = r("<tr/>", {
                "class": g ? d[0] : ""
            }).append(r("<td />", {
                valign: "top",
                colSpan: vt(n),
        ...
        function hi(n, t, i) {
            ...
            t && t.__legacy && (f = {}, l = /(.*?)\[\]$/, r.each(t, function (n, t) {
        ...
        function yu(n) {
            ...
            }, i = 0; i < y; i++) f = l[i], o = d[i], a = typeof f.mData == "function" ? "function" : f.mData, s.columns.push({
                data: a,
                name: f.sName,
        ...
        function wu(n) {
            var o = n.oClasses,
                ...
                c = u?'<label><a href="javascript:void(0);" class="btn_reset btn btn-sm btn-blue">重置</a></lable><label><a href="javascript:void(0);" class="btn_dt btn btn-sm btn-azure">查询</a></lable>':'<label><div style="height:30px;">&nbsp;</div></label>',
                f, e;
            f = r("<form/>").append(r("<div/>", {
                id: h.f ? null : s + "_filter",
                "class": o.sFilter
            }).append(u).append(c));
            
            e = r('a', f).bind("click.DT", function () {
            	if($(this).hasClass('btn_reset'))
            		f[0].reset();
            	n._iDisplayStart = 0; 
                it(n);
            }).bind("keypress.DT", function (n) {
                if (n.keyCode == 13) return 1
            }).attr("aria-controls", s);
            r(n.nTable).on("filter.DT", function () {
                try {
        ...
        function bu(n) {
            for (var i, t, o, f, s, e = u.ext.search, h = ut(n, "bSearchable"), r = 0, c = e.length; r < c; r++) for (i = 0, t = 0, o = n.aiDisplay.length; t < o; t++) f = n.aiDisplay[t - i], s = e[r](n, cu(n, f, "filter", h), f), s || (n.aiDisplay.splice(t - i, 1), i++)
        }
        function ku(n, t, i, r, u, f) {
            var s, o, h, e;
            if (t !== "") for (o = n.aiDisplay, h = sr(t, r, u, f), e = o.length - 1; e >= 0; e--) s = n.aoData[o[e]]._aFilterData[i], h.test(s) || o.splice(e, 1)
        }
        ...
        function sr(n, t, i, r) {
            var f, u = t ? n : gu(n);
            return i && (f = u.split(" "), u = "^(?=.*?" + f.join(")(?=.*?") + ").*$"), new RegExp(u, r ? "i" : "")
        }
        function gu(n) {
            var t = new RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)", "g");
        ...
        function nf(n) {
            for (var s = n.aoColumns, f, r, c, e, t, o, l = u.ext.type.search, a = !1, i = 0, h = n.aoData.length; i < h; i++) if (o = n.aoData[i], !o._aFilterData) {
                for (e = [], r = 0, c = s.length; r < c; r++) f = s[r], f.bSearchable ? (t = v(n, i, r, "filter"), t = l[f.sType] ? l[f.sType](t) : t !== null ? t : "") : t = "", t.indexOf && t.indexOf("&") !== -1 && (li.innerHTML = t, t = se ? li.textContent : li.innerText, t = t.replace(/[\r\n]/g, "")), e.push(t);
                o._aFilterData = e;
        ...
        function tf(n) {
            ...
            return i || (n.aoDrawCallback.push({
                fn: rf,
                sName: "information"
            }), u.attr("role", "alert").attr("aria-live", "polite").attr("aria-relevant", "all"), r(n.nTable).attr("aria-describedby", t + "_info")), u[0]
        }
        function rf(n) {
        ...
        function ai(n) {
            ...
            for (au(n), lu(n), tt(n, n.aoHeader), tt(n, n.aoFooter), k(n, !0), s.bAutoWidth && lr(n), t = 0, u = f.length; t < u; t++) i = f[t], i.sWidth && (i.nTh.style.width = e(i.sWidth));
            rt(n);
            r = b(n);
            r != "ssp" && (r == "ajax" ? hi(n, [], function (i) {
                var r = ci(n, i);
        ...
        function ff(n) {
            for (var f, o, s = n.oClasses, e = n.sTableId, t = n.aLengthMenu, h = r.isArray(t[0]), c = h ? t[0] : t, l = h ? t[1] : t, u = r("<select/>", {
                name: e + "_length",
                "aria-controls": e,
                "class": s.sLengthSelect
            }), i = 0, a = c.length; i < a; i++) u[0][i] = new Option(l[i], c[i]);
            return f = r("<div><label/><\/div>").addClass(s.sLength), n.aanFeatures.l || (f[0].id = e + "_length"), o = n.oLanguage.sLengthMenu.split(/(_MENU_)/), f.children().append(o[0]).append(u).append(o[2]), u.val(n._iDisplayLength).bind("change.DT", function () {
                hr(n, r(this).val());
                it(n)
            }), r(n.nTable).bind("length", function (n, t, i) {
                u.val(i)
            }), f[0]
        }
        function ef(n) {
            ...
            return o || t.fnInit(n, i, s), f.p || (i.id = n.sTableId + "_paginate", n.aoDrawCallback.push({
                fn: function (n) {
                    if (o) for (var l = n._iDisplayStart, r = n._iDisplayLength, a = n.fnRecordsDisplay(), u = r === -1, e = u ? 0 : Math.ceil(l / r), h = u ? 1 : Math.ceil(a / r), v = t(e, h), i = 0, c = f.p.length; i < c; i++) pr(n, "pageButton")(n, f.p[i], i, v, e, h);
                    else t.fnUpdate(n, s)
                },
                sName: "pagination"
            })), i
        ...
        function cr(n, t, i) {
            var r = n._iDisplayStart,
                ...
                f = n.fnRecordsDisplay(),
                e;
            return f === 0 || u === -1 ? r = 0 : typeof t == "number" ? (r = t * u, r > f && (r = 0)) : t == "first" ? r = 0 : t == "previous" ? (r = u >= 0 ? r - u : 0, r < 0 && (r = 0)) : t == "next" ? r + u < f && (r += u) : t == "last" ? r = Math.floor((f - 1) / u) * u : ot(n, 0, "Unknown paging action: " + t, 5), e = n._iDisplayStart !== r, n._iDisplayStart = r, s(n, null, "page", [n]), i && it(n), e
        }
        function of(n) {
            return r("<div/>", {
        ...
        function sf(n) {
            ...
            return u && r(p).scroll(function () {
                ...
                y.scrollLeft = n;
                s && (w.scrollLeft = n)
            }), n.nScrollHead = y, n.nScrollBody = p, n.nScrollFoot = w, n.aoDrawCallback.push({
                fn: kt,
                sName: "scrolling"
            }), l[0]
        }
        function kt(n) {
            ...
            o.scroll();
            (n.bSorted || n.bFiltered) && (i.scrollTop = 0)
        }
        function d(n, t, i) {
        ...
        function lr(t) {
            for (var c = t.nTable, s = t.aoColumns, p = t.oScroll, g = p.sY, l = p.sX, nt = p.sXInner, w = s.length, o = ut(t, "bVisible"), h = r("th", t.nTHead), a = c.getAttribute("width"), v = c.parentNode, tt = !1, u, b, k, d, f, it, y, i = 0; i < o.length; i++) u = s[o[i]], u.sWidth !== null && (u.sWidth = cf(u.sWidthOrig, v), tt = !0);
            if (tt || l || g || w != vt(t) || w != h.length) {
                for (f = r(c.cloneNode(!1)).css("visibility", "hidden").removeAttr("id").append(r(t.nTHead).clone(!1)).append(r(t.nTFoot).clone(!1)).append(r("<tbody><tr/><\/tbody>")), f.find("tfoot th, tfoot td").css("width", ""), it = f.find("tbody tr"), h = si(t, f.find("thead")[0]), i = 0; i < o.length; i++) u = s[o[i]], h[i].style.width = u.sWidthOrig !== null && u.sWidthOrig !== "" ? e(u.sWidthOrig) : "";
                if (t.aoData.length) for (i = 0; i < o.length; i++) b = o[i], u = s[b], r(af(t, b)).clone(!1).append(u.sContentPadding).appendTo(it);
                if (f.appendTo(v), l && nt ? f.width(nt) : l ? (f.css("width", "auto"), f.width() < v.offsetWidth && f.width(v.offsetWidth)) : g ? f.width(v.offsetWidth) : a && f.width(a), lf(t, f[0]), l) {
                    for (y = 0, i = 0; i < o.length; i++) u = s[o[i]], d = r(h[i]).outerWidth(), y += u.sWidthOrig === null ? d : parseInt(u.sWidth, 10) + d - r(h[i]).width();
                    f.width(e(y));
                    c.style.width = e(y)
                }
                for (i = 0; i < o.length; i++) u = s[o[i]], k = r(h[i]).width(), k && (u.sWidth = e(k));
                c.style.width = e(f.css("width"));
                f.remove()
            } else for (i = 0; i < w; i++) s[i].sWidth = e(h.eq(i).width());
            a && (c.style.width = e(a));
            (a || l) && !t._reszEvt && (r(n).bind("resize.DT-" + t.sInstance, hf(function () {
                lt(t)
            })), t._reszEvt = !0)
        }
        function hf(n) {
        ...
        function lf(n, t) {
            var i = n.oScroll,
                u;
            (i.sX || i.sY) && (u = i.sX ? 0 : i.iBarWidth, t.style.width = e(r(t).outerWidth() - u))
        }
        function af(n, t) {
            var i = vf(n, t),
                u;
        ...
        function vf(n, t) {
            for (var i, u = -1, f = -1, r = 0, e = n.aoData.length; r < e; r++) i = v(n, r, t, "display") + "", i = i.replace(he, ""), i.length > u && (u = i.length, f = r);
            return f
        }
        function e(n) {
        ...
        function et(n) {
            var f, e, a, v = [],
                y = n.aoColumns,
                s, h, c, l, t = n.aaSortingFixed,
                p = r.isPlainObject(t),
                i = [],
                o = function (n) {
                    n.length && !r.isArray(n[0]) ? i.push(n) : i.push.apply(i, n)
                };
            for (r.isArray(t) && o(t), p && t.pre && o(t.pre), o(n.aaSorting), p && t.post && o(t.post), f = 0; f < i.length; f++) for (l = i[f][0], s = y[l].aDataSort, e = 0, a = s.length; e < a; e++) h = s[e], c = y[h].sType || "string", v.push({
                src: l,
                col: h,
                dir: i[f][1],
                index: i[f][2],
        ...
        function pf(n) {
            var t, s, h, r = [],
                ...
                i = et(n);
            for (tr(n), t = 0, s = i.length; t < s; t++) o = i[t], o.formatter && l++, kf(n, o.col);
        ...
        function wf(n) {
            for (var u, f, s = n.aoColumns, t = et(n), h = n.oLanguage.oAria, i = 0, l = s.length; i < l; i++) {
                var r = s[i],
                    e = r.asSorting,
        ...
        function bf(n, t, u, f) {
            var l = n.aoColumns[t],
                ...
                s, c = function (n) {
                    var t = n._idx;
                    return t === i && (t = r.inArray(n[1], o)), t + 1 >= o.length ? 0 : t + 1
                },
                h;
        ...
        function yi(n) {
            ...
            if (s.bSort && s.bSortClasses) {
                for (t = 0, i = e.length; t < i; t++) u = e[t].src, r(p(n.aoData, "anCells", u)).removeClass(o + (t < 2 ? t + 1 : 3));
                for (t = 0, i = f.length; t < i; t++) u = f[t].src, r(p(n.aoData, "anCells", u)).addClass(o + (t < 2 ? t + 1 : 3))
            }
            n.aLastSort = f
        }
        function kf(n, t) {
            var s = n.aoColumns[t],
                ...
                h, r, e, o, i, c;
            for (f && (h = f.call(n.oInstance, n, t, at(n, t))), o = u.ext.type.order[s.sType + "-pre"], i = 0, c = n.aoData.length; i < c; i++) r = n.aoData[i], r._aSortData || (r._aSortData = []), (!r._aSortData[t] || f) && (e = f ? h[i] : v(n, i, t, "sort"), r._aSortData[t] = o ? o(e) : e)
        }
        function pi(n) {
        ...
        function df(n) {
            ...
            if (n.oFeatures.bStateSave && (t = n.fnStateLoadCallback.call(n.oInstance, n), t) && (o = s(n, "aoStateLoadParams", "stateLoadParams", [n, t]), r.inArray(!1, o) === -1) && !(t.iCreate < (new Date).getTime() - n.iStateDuration * 1e3) && e.length === t.aoSearchCols.length) {
                for (n.oLoadedState = r.extend(!0, {}, t), n._iDisplayStart = t.iStart, n.iInitDisplayStart = t.iStart, n._iDisplayLength = t.iLength, n.aaSorting = [], u = t.aaSorting, i = 0, f = u.length; i < f; i++) n.aaSorting.push(u[i][0] >= e.length ? [0, u[i][1]] : u[i]);
        ...
        function tu(n, t) {
            var i = [],
                r = nu.numbers_length,
                u = Math.floor(r / 2);
            return t <= r ? i = ht(0, t) : n <= u ? (i = ht(0, r - 2), i.push("ellipsis"), i.push(t - 1)) : n >= t - 1 - u ? (i = ht(t - (r - 2), t), i.splice(0, 0, "ellipsis"), i.splice(0, 0, 0)) : (i = ht(n - 1, n + 2), i.push("ellipsis"), i.push(t - 1), i.splice(0, 0, "ellipsis"), i.splice(0, 0, 0)), i.DT_el = "span", i
        }
        var u, l, o, f, c, iu = /[\r\n]/g,
            gt = /<.*?>/g,
            bi = /[',$£€¥%]/g,
            ...
            ki = function (n, t) {
                return t && typeof n == "string" && (n = n.replace(bi, "")), !n || n === "-" || !isNaN(parseFloat(n)) && isFinite(n)
            },
            fe = function (n) {
        ...
        u = function (n) {
            ...
            var f = this,
                c = n === i,
                a = this.length;
            return c && (n = {}), this.each(function () {
                var e = a > 1 ? gf({}, n, !0) : n,
                    o = 0,
                    v, k = this.getAttribute("id"),
                    lt = !1,
                    h = u.defaults,
                    l, at, vt, t, ht, rt, ut, d, tt, ct, it, yt, ft, st, p;
                ...
                if ((k === null || k === "") && (k = "DataTables_Table_" + u.ext._unique++, this.id = k), t = r.extend(!0, {}, u.models.oSettings, {
                    nTable: this,
                    oApi: f.internal,
                    oInit: e,
                ...
                ]), w(t.oLanguage, e, "fnInfoCallback"), y(t, "aoDrawCallback", e.fnDrawCallback, "user"), y(t, "aoServerParams", e.fnServerParams, "user"), y(t, "aoStateSaveParams", e.fnStateSaveParams, "user"), y(t, "aoStateLoadParams", e.fnStateLoadParams, "user"), y(t, "aoStateLoaded", e.fnStateLoaded, "user"), y(t, "aoRowCallback", e.fnRowCallback, "user"), y(t, "aoRowCreatedCallback", e.fnCreatedRow, "user"), y(t, "aoHeaderCallback", e.fnHeaderCallback, "user"), y(t, "aoFooterCallback", e.fnFooterCallback, "user"), y(t, "aoInitComplete", e.fnInitComplete, "user"), y(t, "aoPreDrawCallback", e.fnPreDrawCallback, "user"), e.bJQueryUI ? (r.extend(t.oClasses, u.ext.oJUIClasses, e.oClasses), e.sDom === h.sDom && h.sDom === "lfrtip" && (t.sDom = '<"H"lfr>t<"F"ip>'), t.renderer ? r.isPlainObject(t.renderer) && !t.renderer.header && (t.renderer.header = "jqueryui") : t.renderer = "jqueryui") : r.extend(t.oClasses, u.ext.classes, e.oClasses), r(this).addClass(t.oClasses.sTable), (t.oScroll.sX !== "" || t.oScroll.sY !== "") && (t.oScroll.iBarWidth = yf()), t.oScroll.sX === !0 && (t.oScroll.sX = "100%"), t.iInitDisplayStart === i && (t.iInitDisplayStart = e.iDisplayStart, t._iDisplayStart = e.iDisplayStart), e.iDeferLoading !== null && (t.bDeferLoading = !0, ht = r.isArray(e.iDeferLoading), t._iRecordsDisplay = ht ? e.iDeferLoading[0] : e.iDeferLoading, t._iRecordsTotal = ht ? e.iDeferLoading[1] : e.iDeferLoading), e.oLanguage.sUrl !== "" ? (t.oLanguage.sUrl = e.oLanguage.sUrl, r.getJSON(t.oLanguage.sUrl, null, function (n) {
                    gi(n);
                    g(h.oLanguage, n);
                    r.extend(!0, t.oLanguage, e.oLanguage, n);
                    ai(t)
                }), lt = !0) : r.extend(!0, t.oLanguage, e.oLanguage), e.asStripeClasses === null && (t.asStripeClasses = [t.oClasses.sStripeOdd, t.oClasses.sStripeEven]), rt = t.asStripeClasses, ut = r("tbody tr:eq(0)", this), r.inArray(!0, r.map(rt, function (n) {
                ...
                if (su(t, e.aoColumnDefs, tt, function (n, i) {
                    ti(t, n, i)
                }), ut.length && (it = function (n, t) {
                    return n.getAttribute("data-" + t) ? t : null
                }, r.each(oi(t, ut[0]).cells, function (n, r) {
                    var e = t.aoColumns[n],
                        u, f;
                ...
                if (yi(t), t.oFeatures.bSort && y(t, "aoDrawCallback", function () {
                    if (t.bSorted) {
                        var n = et(t),
                            i = {};
        ...
        o.prototype = {
            ...
            each: function (n) {
                ...
                else for (var t = 0, i = this.length; t < i; t++) n.call(this, this[t], t, this);
                return this
            },
            filter: function (n) {
                var i = [],
            ...
            iterator: function (n, t, r) {
                var e = [],
                    f, u, p, h, w, s = this.context,
                    b, v, c, l = this.selector,
                    y, a;
                for (typeof n == "string" && (r = t, t = n, n = !1), u = 0, p = s.length; u < p; u++) if (t === "table") f = r(s[u], u), f !== i && e.push(f);
                else if (t === "columns" || t === "rows") f = r(s[u], this[u], u), f !== i && e.push(f);
                else if (t === "column" || t === "column-rows" || t === "row" || t === "cell") for (v = this[u], t === "column-rows" && (b = gr(s[u], l.opts)), h = 0, w = v.length; h < w; h++) c = v[h], f = t === "cell" ? r(s[u], c.row, c.column, u, h) : r(s[u], c, u, h, b), f !== i && e.push(f);
        ...
        o.extend = function (n, t, i) {
            if (t && (t instanceof o || t.__dt_wrapper)) for (var r, e = function (t, i) {
                return function () {
                    ...
                    return o.extend(r, r, i.methodExt), r
                }
            }, u = 0, f = i.length; u < f; u++) r = i[u], t[r.name] = typeof r.val == "function" ? e(r.val, r) : r.val, t[r.name].__dt_wrapper = !0, o.extend(n, t[r.name], r.propExt)
        };
        o.register = f = function (n, t) {
            ...
            for (var s = n.split("."), c = ne, l, a, y = function (n, t) {
                ...
                return null
            }, i = 0, h = s.length; i < h; i++) a = s[i].indexOf("()") !== -1, l = a ? s[i].replace("()", "") : s[i], f = y(c, l), f || (f = {
                name: l,
                val: {},
                methodExt: [],
                propExt: []
            }, c.push(f)), i === h - 1 ? f.val = t : c = a ? f.methodExt : f.propExt;
            o.ready && u.api.build()
        };
        ...
        c("tables().nodes()", "table().node()", function () {
            return this.iterator("table", function (n) {
                return n.nTable
            })
        });
        c("tables().body()", "table().body()", function () {
            return this.iterator("table", function (n) {
                return n.nTBody
            })
        });
        c("tables().header()", "table().header()", function () {
            return this.iterator("table", function (n) {
                return n.nTHead
            })
        });
        c("tables().footer()", "table().footer()", function () {
            return this.iterator("table", function (n) {
                return n.nTFoot
            })
        });
        ...
        wr = function (n, t, i) {
            b(n) == "ssp" ? rt(n, t) : hi(n, [], function (r) {
                var f, u, e;
        ...
        var br = function (n, t) {
            var o = [],
                e, f, i, s, u, h;
            for (r.isArray(n) || (n = [n]), i = 0, s = n.length; i < s; i++) for (f = n[i] && n[i].split ? n[i].split(",") : [n[i]], u = 0, h = f.length; u < h; u++) e = t(typeof f[u] == "string" ? r.trim(f[u]) : f[u]), e && e.length && o.push.apply(o, e);
            return o
        },
            kr = function (n) {
            ...
            gr = function (n, t) {
                ...
                else if (s == "current" || s == "applied") u = f == "none" ? c.slice() : f == "applied" ? o.slice() : r.map(c, function (n) {
        ...
        c("rows().cache()", "row().cache()", function (n) {
            return this.iterator("row", function (t, i) {
                var r = t.aoData[i];
                return n === "search" ? r._aFilterData : r._aSortData
            })
        });
        c("rows().invalidate()", "row().invalidate()", function (n) {
            return this.iterator("row", function (t, i) {
                ei(t, i, n)
            })
        });
        c("rows().indexes()", "row().index()", function () {
            return this.iterator("row", function (n, t) {
                return t
            })
        });
        ...
        f("rows.add()", function (n) {
            var i = this.iterator("table", function (t) {
                for (var i, u = [], r = 0, f = n.length; r < f; r++) i = n[r], i.nodeName && i.nodeName.toUpperCase() === "TR" ? u.push(ri(t, i)[0]) : u.push(nt(t, i));
                return u
            }),
                t = this.rows(-1);
        ...
        var ae = function (n, t, i, u) {
            ...
            ie = function (n) {
                var i = this.context,
                    t;
                return i.length && this.length && (t = i[0].aoData[this[0]], t._details && (t._detailsShow = n, n ? t._details.insertAfter(t.nTr) : t._details.remove(), ve(i[0]))), this
            },
            ve = function (n) {
                var t = r(n.nTable),
                    i = ".dt.DT_details";
                if (t.off("draw" + i), t.off("column-visibility" + i), p(n.aoData, "_details").length > 0) {
                    t.on("draw" + i, function () {
                    ...
                    t.on("column-visibility" + i, function (n, t) {
                        for (var i, u = vt(t), r = 0, f = t.aoData.length; r < f; r++) i = t.aoData[r], i._details && i._details.children("td[colspan]").attr("colspan", u)
                    })
                }
            };
        ...
        var ye = /^(.*):(name|visIdx|visible)$/,
            pe = function (n, t) {
                ...
                return br(t, function (t) {
                    ...
                    case "visIdx":
                    case "visible":
                        return (s = parseInt(e[1], 10), s < 0) ? (h = r.map(i, function (n, t) {
            ...
            we = function (n, t, u) {
                ...
                if (e.bVisible !== u) {
                    if (u) for (v = r.inArray(!0, p(l, "bVisible"), t + 1), f = 0, a = o.length; f < a; f++) c = o[f].nTr, h = o[f].anCells, c && c.insertBefore(h[t], h[v] || null);
                    else r(p(n.aoData, "anCells", t)).remove(), e.bVisible = !1, tt(n, n.aoHeader), tt(n, n.aoFooter), pi(n);
                    e.bVisible = u;
                    tt(n, n.aoHeader);
                    tt(n, n.aoFooter);
                    lt(n);
                    (n.oScroll.sX || n.oScroll.sY) && kt(n);
        ...
        return f("columns()", function (n, t) {
            ...
            if (r.isPlainObject(n) && (u = n, n = null), r.isPlainObject(t) && (u = t, t = null), t === null || t === i) return this.iterator("table", function (t) {
                return re(t, n, kr(u))
            });
        ...
        }), c("cells().nodes()", "cell().node()", function () {
            ...
            var t = this.selector;
            return this.rows(t.rows, t.opts).invalidate(n), this
            ...
            return n === i ? e.length !== 0 ? e[0].oPreviousSearch.sSearch : i : this.iterator("table", function (i) {
                i.oFeatures.bFilter && bt(i, r.extend({}, i.oPreviousSearch, {
                    sSearch: n + "",
                    bRegex: t === null ? !1 : t,
                    bSmart: u === null ? !0 : u,
        ...
        }, u.camelToHungarian = g, f("$()", function (n, t) {
            ...
            f(t + "()", function () {
                var n = Array.prototype.slice.call(arguments),
                    i;
                return n[0].indexOf(".dt") === -1 && (n[0] += ".dt"), i = r(this.tables().nodes()), i[t].apply(i, n), this
            })
        }), f("clear()", function () {
            return this.iterator("table", function (n) {
                ui(n)
        ...
        }), u.version = "1.10.0-beta.1", u.settings = [], u.models = {}, u.models.oSearch = {
            bCaseInsensitive: !0,
            sSearch: "",
            bRegex: !1,
            bSmart: !0
                ...
                _: function (n, t, i, u, f, e) {
                    var h = n.oClasses,
                        ...
                        o, s, l = function (t, u) {
                            ...
                            }, w, v = 0, y = u.length; v < y; v++) if (a = u[v], r.isArray(a)) w = r("<" + (a.DT_el || "div") + "/>").appendTo(t), l(w, a);
                            else {
                                o = "";
                                s = "";
                                switch (a) {
            ...
            header: {
                _: function (n, t, i, u) {
                    r(n.nTable).on("order.dt", function (n, r, f, e) {
                        var o = i.idx;
                ...
                jqueryui: function (n, t, i, u) {
                    ...
                    r(n.nTable).on("order.dt", function (n, r, e, o) {
