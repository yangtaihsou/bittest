...
(function($,w){
	...
	'<p>@{msgContent}</p><input type="text" class="form-control JPromptInput" value="@{defaultVal}" placeholder="请输入..."/></div>  <div class="modal-footer"><a role="button" class="btn btn-success JConfirmBtn">确定</a>'+
