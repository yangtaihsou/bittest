...
<form id="erpform" onsubmit="return false;" class="form-horizontal form-bordered" role="form">
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <input type="text" id="systemName" name="systemName" class="form-control" value="${systemVo.systemName}" columWidthClass="col-xs-8" required data-bv-notempty-message="系统名称不能为空"  />
        </div>
        <div class="form-group">
            <label class="from-control col-xs-4">系统域名</label>
            <input type="text" id="domainName" name="domainName" class="form-control" columWidthClass="col-xs-8" value="${systemVo.domainName}" required data-bv-notempty-message="域名不能为空"  placeholder="如：test.bit.com"/>
        </div>
        <div class="form-group">
            <label class="from-control col-xs-4">邮件地址</label>
            <input type="text" id="ip" name="ip" class="form-control" columWidthClass="col-xs-8" value="${systemVo.ip}" placeholder="请输入邮件地址" />
        </div>
        <div class="form-group">
            <label class="from-control col-xs-4">备&nbsp;&nbsp;&nbsp;&nbsp;注</label>
            <textarea id="remark" name="remark"  class="form-control" rows="3" columWidthClass="col-xs-8">${systemVo.remark}</textarea>
        </div>
    </div><!-- /.box-body -->
...
<footer>
    ...
    <script type="text/javascript">
        ...
        function dataSubmit(){
            ...
            me.postAjaxCallBack(erpform,'/system/systemEdit',submitCallBack,"");
        }
