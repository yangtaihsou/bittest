...
<form id="jsfForm" onsubmit="return false;" class="form-bordered" role="form">
    ...
    <input  type="hidden" id="interfaceId" name="interfaceId" value="${interfaces.interfaceId}" />
    <div class="row">
        <div class="col-xs-12">
                                    ...
                                    <div class="panel-body">
                                        <div class="nav-tabs-custom">
                                            <ul id="nav" class="nav nav-tabs">
                                                <li
                                                ><a id="1" href="#JSF" >dubbo 请求</a></li>
                                                <li
                                                ><a id="2" href="#POST" >HTTP POST</a></li>
                                                <li
                                                ><a id="3" href="#GET" >HTTP GET</a></li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="JSF">
                                                    <div class="row">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="jsf_interfaceName" name="jsf_interfaceName" class="form-control" columWidthClass="col-xs-6" placeholder="添加接口后的展示名称"
                                                                        <c:if test="${interfaces.type==1}">
                                                                            value ="${interfaces.name}"
                                                                        </c:if>
                                                                    />
                                                                    <button type="submit" id="jsfResolve" class="btn btn-success">解析接口</button>&nbsp;&nbsp;
                                                                    <button type="submit" <c:if test="${interfaces.type!=1}">disabled="disabled"</c:if> id="jsfRequest" class="btn btn-info">执行接口</button>&nbsp;&nbsp;
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="jsf_alias" name="jsf_alias" class="form-control" columWidthClass="col-xs-5" onchange="getIps();">
                                                                        <c:if test="${interfaces.type==1}">
                                                                            <option value="${interfaces.alias}"> ${interfaces.alias}</option>
                                                                        </c:if>
                                                                    </select>
                                                                    <label class="col-xs-1 control-label">token</label>
                                                                    <input type="text" id="jsf_token" name="jsf_token" class="form-control" columWidthClass="col-xs-5" value="${interfaces.token}"/>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea id="jsf_body" name="jsf_body" class="form-control" rows="16" columWidthClass="col-xs-5"><c:if test="${interfaces.type==1}">${interfaces.body}</c:if></textarea>
                                                        ...
                                                        <%--<div class="col-xs-6">--%>
                                                            <%--<p class=""><b>接口返回信息</b></p>--%>
                                                            <%--<div class="box-body">--%>

                                                                <%--<div class="form-group">--%>
                                                                    <%--<label class="col-xs-1  control-label">调用状态</label>--%>
                                                                    <%--<input id="jsf_res_code"  class="form-control" columWidthClass="col-xs-9" />--%>
                                                                <%--</div>--%>
                                                                <%--<div class="form-group">--%>
                                                                    <%--<label class="col-xs-1  control-label">请求值</label>--%>
                                                                    <%--<textarea  id="jsf_req_body" class="form-control" rows="16" columWidthClass="col-xs-9"></textarea>--%>
                                                                <%--</div>--%>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="box-body">
                                                                    ...
                                                                    <c:when test="${interfaces.type==2}">
                                                                        <c:forEach items="${interfaces.headMap}" var="head"  varStatus="index">
                                                                            <div class="form-group" id="post_head${index.index}" name="post_head">
                                                                                ...
                                                                                <input type="text"  name="headKey" class="form-control" columWidthClass="col-xs-3" placeholder="key" value="${head.key}"/>
                                                                                <input type="text"  name="headValue" class="form-control" columWidthClass="col-xs-3" placeholder="value" value="${head.value}" />
                                                                                <c:choose>
                                                                ...
                                                                <div class="col-xs-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-xs-1  control-label">请求值</label>
                                                                        <textarea id="post_body" name="post_body" class="form-control" rows="16" columWidthClass="col-xs-5"><c:if test="${interfaces.type==2}">${interfaces.body}</c:if></textarea>
                                                                        <label class="col-xs-1  control-label">返回值</label>
                                                ...
                                                <c:if test="${interfaces.checkPointList!=null}">
                                                    <c:forEach items="${interfaces.checkPointList}" var="checkPoint"  varStatus="index">
                                                        <div class="form-group" id="userCheck${index.index}" name="userCheck" >
                                                            ...
                                                            <div class="col-xs-4">
                                                                <select name="checkPointList[${index.index}].checkMethod" class="form-control">
                                                ...
                                                <c:if test="${interfaces.dataCheckList!=null}">
                                                    <c:forEach items="${interfaces.dataCheckList}" var="dataCheck"  varStatus="index">
                                                        <div class="form-group" id="userDataCheck${index.index}" name="userDataCheck">
                                                            ...
                                                            <div class="col-xs-2">
                                                                <select class="form-control" name="dataCheckList[${index.index}].databaseId">
                                                            ...
                                                            <div class="col-xs-3">
                                                                <textarea   class="form-control" rows="3" name="dataCheckList[${index.index}].wheres" placeholder="请输入select之后的查询语句(单列查询)">${dataCheck.wheres}</textarea>
                                                            </div>
                                                            <label class="col-xs-1" style="width:30px;padding-left:0px;padding-right:0px;padding-top: 7px;">规则</label>
                                                            <div class="col-xs-2">
                                                                <select name="dataCheckList[${index.index}].checkMethod" class="form-control">
                                                            ...
                                                            <div class="col-xs-2">
                                                                <input class="form-control" name="dataCheckList[${index.index}].checkValue"  placeholder="匹配的内容" value="${dataCheck.checkValue}"/>
                                                            </div>
                                                            <button type="button" name="removeDiv" class="btn btn-danger btn-xs">删除</button>
                                                        <%--执行后根据结果动态添加--%>
                                                        </div>
                                                ...
                                                <c:if test="${interfaces.dataFetchList!=null}">
                                                    <c:forEach items="${interfaces.dataFetchList}" var="dataFetch"  varStatus="index">
                                                        <div class="form-group" id="userFetch${index.index}" name="userFetch" >
                                                            <label class="col-xs-1 control-label" class="col-xs-2 control-label" style="width:70px;padding-left:0px;padding-right:0px;padding-top: 7px;">提取名称</label>
                                                            <div class="col-xs-2">
                                                            ...
                                                            <label class="col-xs-1 control-label" class="col-xs-2 control-label" style="width:50px;padding-left:0px;padding-right:0px;padding-top: 7px;">表达式</label>
                                                            <div class="col-xs-4">
                                                            ...
                                                            <label class="col-xs-1 control-label" class="col-xs-2 control-label" style="width:70px;padding-left:0px;padding-right:0px;padding-top: 7px;">提取索引</label>
                                                            <div class="col-xs-2">
                                                                <input type="text"  name="dataFetchList[${index.index}].regularIndex" class="form-control" value="${dataFetch.regularIndex}"/>
                                                            </div>
                                                            <button type="button" name="removeDiv" class="btn btn-danger btn-xs">删除</button>
                                                        </div>
                                                    </c:forEach>
...
//                    $("#jsf_res_body").val(data.value.resBody);
        ...
        function saveSubmit(){
            var jsfForm = $('#jsfForm').serialize();
            me.postAjaxCallBack(jsfForm,'/interface/interfaceEdit',submitCallBack,"");
        }
