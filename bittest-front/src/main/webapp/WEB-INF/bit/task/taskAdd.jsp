...
<form id="erpform" onsubmit="return false;" class="form-horizontal form-bordered" role="form">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="taskName" name="taskName" class="form-control" columWidthClass="col-xs-8" required  />
                        </div>
                        <div class="form-group">
                            <label class="from-control col-xs-4">所属系统</label>
                            <select id="sysId" name="sysId" class="form-control" columWidthClass="col-xs-8" columWidthClass="col-xs-8" required>
    ...
    <div class="box-footer">
        <button type="submit" id="btnSave" class="btn btn-info pull-right btn-submit" >下一步</button>
    </div><!-- /.box-footer -->
</form>
<footer>
...
//            addDiv();
        ...
        function dataSubmit(){
            ...
            me.postAjaxCallBack(erpform,'/task/taskAdd',submitCallBack,"");
        }
        ...
        function submitCallBack(data){
            ...
            if(data.code == "000000"){
                ...
                var title = "任务计划管理";
                var url = "<%=request.getContextPath()%>/task/toTaskEdit?taskId="+data.value.taskId;
                window.parent.addTabs(tabid , title , url , true);
            }else{
                $("#erpform").data('bootstrapValidator').destroy();
                alertBootbox("保存任务计划信息失败，请联系管理员！");
                return;
            };
        }
