...
<form id="erpform" onsubmit="return false;" class="form-horizontal form-bordered" role="form">
    <div class="box-body">
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" columWidthClass="col-xs-8" required data-bv-notempty-message="数据库名称不能为空"  />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" id="url" name="url" class="form-control" columWidthClass="col-xs-6" required data-bv-notempty-message="数据库连接不能为空" placeholder="例如:172.0.0.1:3306/库名" />
            <button type="submit" id="btnConnect" class="btn btn-success" >测试连接</button>
        </div>
        <div class="form-group">
            <label class="from-control col-xs-4">用户名</label>
            <input type="text" id="username" name="username" class="form-control" columWidthClass="col-xs-8" required data-bv-notempty-message="用户名不能为空"  />
        </div>
        <div class="form-group">
            <label class="from-control col-xs-4">密&nbsp;&nbsp;&nbsp;&nbsp;码</label>
            <input type="password" id="password" name="password" class="form-control" columWidthClass="col-xs-8" required data-bv-notempty-message="数据库密码不能为空"  />
        </div>
        <div class="form-group">
...
<footer>
    ...
    <script type="text/javascript">
        ...
        function dataSubmit(){
            ...
            me.postAjaxCallBack(erpform,'/database/dataBaseAdd',submitCallBack,"");
        }
        ...
        function submitCallBack(data){
            ...
            if(data.code == "000000"){
                ...
                alertBootbox("亲，保存数据库信息失败了，请联系管理员！");
                return;
            };
