...
<form id="erpform" onsubmit="return false;" class="form-horizontal form-bordered" role="form">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" columWidthClass="col-xs-8" required data-bv-notempty-message="名称不能为空"  value="${sleep.name}" />
        </div>
        <div class="form-group">
            <label class="from-control col-xs-4">sleep</label>
            <input type="text" id="body" name="body" class="form-control" columWidthClass="col-xs-8" value="${sleep.body}" required data-bv-notempty-message="等待时长不能为空" placeholder="等待时长单位毫秒" />
        </div>
        <div class="form-group">
            <label class="from-control col-xs-4">备&nbsp;&nbsp;&nbsp;&nbsp;注</label>
            <textarea id="remark" name="remark" class="form-control" rows="3" columWidthClass="col-xs-8">${sleep.remark}</textarea>
        </div>
    </div><!-- /.box-body -->
