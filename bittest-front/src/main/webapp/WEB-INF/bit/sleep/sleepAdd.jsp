...
<form id="erpform" onsubmit="return false;" class="form-horizontal form-bordered" role="form">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" columWidthClass="col-xs-8" required data-bv-notempty-message="名称不能为空"  value="延迟等待" />
        </div>
        <div class="form-group">
            <label class="from-control col-xs-4">sleep</label>
            <input type="text" id="body" name="body" class="form-control" columWidthClass="col-xs-8" required data-bv-notempty-message="等待时长不能为空" placeholder="等待时长单位毫秒" />
        </div>
        <div class="form-group">
...
<footer>
    ...
    <script type="text/javascript">
        ...
        function dataSubmit(){
            ...
            me.postAjaxCallBack(erpform,'/sleep/sleepAdd',submitCallBack,"");
        }
        ...
        function submitCallBack(data){
            ...
            if(data.code == "000000"){
                ...
                alertBootbox("亲，保存sleep信息失败了，请联系管理员！");
                return;
            };
