...
public class RetryRuntimeException extends RuntimeException {
    ...
    public RetryRuntimeException(Map extBizInfo) {
        this.extBizInfo = extBizInfo;
    }

    public RetryRuntimeException(String showMessage) {
        super(showMessage);
        this.showMessage = showMessage;
    }

    public RetryRuntimeException(Throwable cause) {
        super(cause);
    }

    public RetryRuntimeException(String errorCode, String errorMessage) {
        this.errorMessage = errorMessage;
        this.errorCode = errorCode;
    }

    public RetryRuntimeException(String errorCode, String errorMessage, Map<String, String> extBizInfo) {
        this.errorMessage = errorMessage;
        this.errorCode = errorCode;
        this.extBizInfo = extBizInfo;
    }

    public RetryRuntimeException(String errorCode, String errorMessage, String showMessage) {
        super(showMessage);
        this.errorMessage = errorMessage;
        this.errorCode = errorCode;
        this.showMessage = showMessage;
    ...
    public RetryRuntimeException(String showMessage, Throwable cause) {
        super(showMessage, cause);
        this.showMessage = showMessage;
        this.cause = cause;
    }

    public RetryRuntimeException(String errorCode, String errorMessage, Throwable cause) {
        super(cause);
        this.errorCode = errorCode;
        this.cause = cause;
        this.errorMessage = errorMessage;
    ...
    public RetryRuntimeException(String errorCode, String errorMessage, String showMessage, Throwable cause) {
        super(showMessage, cause);
        this.cause = cause;
        this.errorCode = errorCode;
        this.errorMessage = errorMessage;
